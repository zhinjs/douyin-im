...
/** Decrypts Douyin's iv(12) + ciphertext + GCM tag(16) image container. */
...
/**
 * Decrypt one cenc-aes-ctr sample. Protected subsamples share one continuous
 * counter stream; clear ranges do not consume the stream.
 */
